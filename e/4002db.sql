...
--
-- Host: localhost:3306
-- Generation Time: Feb 20, 2026 at 03:51 PM
...
CREATE TABLE `admin` (
  ...
  `a_usrename` varchar(255) NOT NULL,
...
INSERT INTO `for_application` (`a_phone`, `a_height`, `a_address`, `a_birthday`, `a_id`, `a_position`, `a_prefix`, `a_fullname`, `a_color`, `a_education`, `a_major`, `a_skills`) VALUES
('098378479', 170, '', '2026-02-12', 2, 'โปรแกรมเมอร์', 'นาย', 'นดล ชมใจ', '#e18989', '', '', ''),
('045364094', 176, '', '2026-02-20', 3, 'ผู้จัดการ', 'นาย', 'ยงยุช', '#000000', '', '', '');
...
INSERT INTO `register` (`r_id`, `r_name`, `r_phone`, `r_height`, `r_address`, `r_birthday`) VALUES
(1, 'จิราภา', '0894576397', 162, 'มหาสารคาม', '2026-02-06'),
(2, 'มัทนา', '0894576397', 164, 'อุดรธานี', '2026-02-11'),
(3, 'ชนาพร', '098576483', 156, 'อุบลราชธานี', '2026-02-02'),
(4, 'สุชาวดี', '0567463827', 172, 'อำนาจเจริญ', '2026-02-07');
